  ...
  const projects = [
    {
      ...
      gradient: 'linear-gradient(135deg, rgba(0, 0, 0, 1) 0%, rgba(10, 10, 10, 0.92) 100%)',
      tag: 'WEB',
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            >
              {[
                { icon: Github, link: 'https://github.com/ApoorvVerma28', label: 'GitHub' },
                { icon: Linkedin, link: 'https://www.linkedin.com/in/apoorv-verma-165758250/', label: 'LinkedIn' },
                { icon: Mail, link: 'mailto:apoorvverma73@gmail.com', label: 'Email' },
              ].map((social, index) => (
                <motion.a
                  key={index}
                  href={social.link}
            ...
            <div className="flex gap-4 w-full max-w-md">
              ...
              <motion.a
                href="mailto:apoorvverma73@gmail.com"
                whileHover={{
                  scale: 1.02,
                  boxShadow: '0 10px 25px rgba(0, 0, 0, 0.1)',
                }}
        ...
        {activeTab === 'portfolio' ? (
          ...
          >
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {['Adaptability', 'Teamwork', 'Management'].map((skill, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
